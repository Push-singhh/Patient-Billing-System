...
<nav class="w3-sidenav w3-teal w3-card-2" style="margin-top:74px;;width:15%; overflow:auto;;">
          ...
          <div id="demoAcc1" class="w3-hide w3-teal w3-card-4">
            ...
            <a href="" class="active" >&nbsp;&nbsp;&nbsp;By Date Of Joining</a>
        ...
        <form class="w3-container" action="" method="post">
            <div class="w3-row-padding">
              ...
              <div class="w3-col l2 center ">
                <input class="w3-input w3-border" name="date" type="text" id="datepicker" placeholder="Enter Date Of Joining">
              </div>
              <div class="w3-col l2">
