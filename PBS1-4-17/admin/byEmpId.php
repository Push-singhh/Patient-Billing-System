...
<nav class="w3-sidenav w3-teal w3-card-2" style="margin-top:74px;;width:15%; overflow:auto;;">
          ...
          <a onclick="myAccFunc1()" href="#" class="active" > <i class="w3-medium material-icons">search</i> View Employee <i  class="fa fa-caret-down"></i></a>
          <div id="demoAcc1" class="w3-hide w3-teal w3-card-4">
            <a href="" class="active" >&nbsp;&nbsp;&nbsp;By Employee Id</a>
        ...
        <form class="w3-container" action="" method="post">
            <div class="w3-row-padding">
              ...
              <div class="w3-col l2 center ">
                <input class="w3-input w3-border" name="billNo" type="text" placeholder="Enter Emp_id">
              </div>
              <div class="w3-col l2">
