$(document).ready(function(){
    ...
    function presentSame(form){

if(form.sameAsPermanent.checked){

     form.addressLine11.value = form.addressLine1.value;
     form.addressLine21.value = form.addressLine2.value;
   
     form.pincode1.value = form.pincode.value;
     
     }else{
     
     form.addressLine11.value = "";
     form.addressLine21.value = "";
     form.pincode1.value = "";
