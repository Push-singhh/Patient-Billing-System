...
<!DOCTYPE html>
<html>
<title>Doctor-Search Patient</title>
...
<div class="w3-row w3-teal" style="position: fixed; width : 100%;">
   ...
   <nav class="w3-sidenav w3-teal w3-card-2" style="position: relative;margin-top: 73px;;width:15%;">
          ...
          <a onclick="myAccFunc1()" href="#" class="active"><i class="w3-medium material-icons">search</i> View Patient <i class="fa fa-caret-down"></i></a>
          <div id="demoAcc1" class="w3-hide w3-teal w3-card-4">
            <a href="" class="active" >&nbsp;&nbsp;&nbsp;By Patient Id</a>
...
<!-------------------------------------Side-Nav Ends-------------------------------> 
<!-------------------------------------By Patient Id starts----------w3-text-brown--------------------->
                	...
                	<table class="w3-table w3-bordered">
                        	...
                        	<?php
								...
								{									
									...
									$query="select * from billinfo where billNo=$billNumber";
									...
									while($row=mysqli_fetch_array($result))
									{
                                        ...
                                        print '<td><a style="color:#f00;" href="viewBill.php?bill='.$row['billNo'].'" target="_blank">'."Update".'</a>
                                                <a style="color:#f00;" href="viewBill.php?bill='.$row['billNo'].'" target="_blank">'."Delete".'</a></td>';
										echo "</tr>";
										echo "</tbody>".'<br>';
