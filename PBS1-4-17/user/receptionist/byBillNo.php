...
<nav class="w3-sidenav w3-teal w3-card-2" style="position: relative;margin-top: 73px;;width:15%;">
          ...
          <a onclick="myAccFunc3()" class="active" href="#"><i class="w3-medium material-icons">search</i> View Bill <i class="fa fa-caret-down"></i></a>
          <div id="demoAcc3" class="w3-hide w3-teal w3-card-4">
            <a href="" class="active" >&nbsp;&nbsp;&nbsp;By Bill Number</a>
        ...
        <form class="w3-container" action="" method="post">
            <div class="w3-row-padding">
              ...
              <div class="w3-col l2 center ">
                <input class="w3-input w3-border" name="billNo" type="text" placeholder="Enter Bill Number">
              </div>
              <div class="w3-col l2">
